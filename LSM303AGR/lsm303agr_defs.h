...
typedef enum
{
    LSM303AGR_TEMP_EN_OFF = 0, LSM303AGR_TEMP_EN_ON = 3,
} LSM303AGR_TEMP_EN_T;
...
typedef enum
{
    LSM303AGR_A_ODR_POWER_DOWN = 0, LSM303AGR_A_ODR_1HZ = 1, // 1Hz, HR/Normal/LP
...
typedef enum
{
    LSM303AGR_A_ST_NORMAL = 0, LSM303AGR_A_ST_0 = 1, LSM303AGR_A_ST_1 = 2,
} LSM303AGR_A_ST_T;
